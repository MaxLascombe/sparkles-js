...
function Mouse(e) {
  y = e.pageY + 4 - window.pageYOffset
  x = e.pageX + 1
}
...
window.onload = function () {
  if (document.getElementById) {
    ...
    for (var i = 0; i < sparkles; i++) {
      ...
      // these are needed or div has 0 width
      rlef.innerHTML = 'hi charlotte'
      rdow.innerHTML = 'hi charlotte'
